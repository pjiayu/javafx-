...
public class PluginLoader {
    ...
    public static void loadresourceAsTab(String url,String tabname, TabPane tabPane) {
        try {
            FXMLLoader generatingCodeFXMLLoader = new FXMLLoader(Main.class.getResource(url));
